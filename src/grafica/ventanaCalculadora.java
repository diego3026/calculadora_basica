...
public class ventanaCalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton17.setText("Calculadora Parcial");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pantalla, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        this.Primernumero = Double.parseDouble(numero);
        numero = "";
        operacion = "+";
    }//GEN-LAST:event_jButton12ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        segundoNumero = Double.parseDouble(numero);
        switch (operacion) {
            case "+":
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        numero="";
        this.resultado=0;
        this.Primernumero = 0d; 
        this.segundoNumero = 0d; 
